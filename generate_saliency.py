...
def main():
    ...
    # 1D Projections
    # 1. Primes (average over twists/characters)
    plt.figure(figsize=(10, 6))
    plt.plot(r0_map.mean(axis=0), label='Rank 0 (Average over twists)')
    plt.plot(r1_map.mean(axis=0), label='Rank 1 (Average over twists)')
    plt.plot(fake_map.mean(axis=0), label='Fake (Average over twists)', linestyle='--')
    ...
    # 2. Twists (average over primes)
    plt.figure(figsize=(10, 6))
    plt.plot(r0_map.mean(axis=1), label='Rank 0 (Average over primes)')
    plt.plot(r1_map.mean(axis=1), label='Rank 1 (Average over primes)')
    plt.plot(fake_map.mean(axis=1), label='Fake (Average over primes)', linestyle='--')
